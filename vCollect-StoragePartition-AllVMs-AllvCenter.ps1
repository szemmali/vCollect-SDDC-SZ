##===================================================================================
##       Project:  vCollect All Storage Partitions for each VMs in DC per AllvCenter
...
##          FILE:  vCollect-StoragePartition-AllVMs-AllvCenter.ps1
...
check-ReportFolder "vCollect-Storage"
